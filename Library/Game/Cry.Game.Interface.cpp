...
namespace Cry
{
	namespace Game
	{
		...
		bool InterfaceEx::SendCmd(lPString lpszString)
		{
			...
			{
				// 发言
				CryVirtualQueryMemory(lPCString, CryVirtualQueryMemory(u32, m_Interface->GetPointer("\xAE\x79\xD1\x03\xB6\x05\xB5\x56\x00\x00"))) = lpszString;
				...
				// 结束
				CryVirtualQueryMemory(lPCString, CryVirtualQueryMemory(u32, m_Interface->GetPointer("\xAE\x79\xD1\x03\xB6\x05\xB5\x56\x00\x00"))) = 0;
